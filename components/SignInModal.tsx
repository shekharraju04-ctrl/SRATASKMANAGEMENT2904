...
export const SignInModal: React.FC<SignInModalProps> = ({ onClose, onSignIn, error, onSwitchToSignUp }) => {
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <input type="email" id="email-signin" value={email} onChange={e => setEmail(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600" />
              </div>
              <div>
                <label htmlFor="password-signin" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Password</label>
                <input type="password" id="password-signin" value={password} onChange={e => setPassword(e.target.value)} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600" />
              </div>
            </div>
          </div>
          ...
          <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row-reverse sm:items-center sm:justify-between rounded-b-lg">
            ...
            <div className='mt-3 sm:mt-0 text-center sm:text-left'>
                <button type='button' onClick={onSwitchToSignUp} className='text-sm text-primary-600 dark:text-primary-400 hover:underline'>
